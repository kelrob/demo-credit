...
exports.withdrawFromAccountValidationRules = exports.transferFundsToAccountValidationRules = exports.fundAccountValidationRules = void 0;
...
const withdrawFromAccountValidationRules = () => {
    return [
        (0, express_validator_1.body)('amount')
            .notEmpty()
            .withMessage('amount is required')
...
exports.withdrawFromAccountValidationRules = withdrawFromAccountValidationRules;
